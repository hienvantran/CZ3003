...
public class ScoreManager : MonoBehaviour
{
    ...
    {
        UpdateScoreDisplay();
        selectionManager.OnSelectionChanged += UpdateScoreDisplay;
    }
    ...
    private void RetrieveUserScoreData()
    {
        ...
        if (worldSelected == "Addition")
        {
            ...
            scoreData.AddUserScore(new UserScore("JanTwin", 1));
        ...
        else
        {
            ...
            scoreData.AddUserScore(new UserScore("JanTwin Others", 1));
